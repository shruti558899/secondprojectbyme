            ...
            <html lang="en">
              <head>
                ...
                <div class="container" style="text-align:center">
                   <a href="{{url('/trash')}}">
                  <button class="btn btn-danger d-inline-block m-2 float-right" type="button">Go to trash</button>
                  </a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{route('trash' , ['id'=>$values->id])}}">
                              <button class="btn btn-danger" type="button">Trash</button>
                              </a>
                              <a href="{{route('edit',['id'=> $values->id])}}">
